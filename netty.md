...
<img src="assets/netty.assets/1555936142010.png" style="zoom:0.8">

Reactor模式没有Queue来做缓冲，每当一个事件输入到Service Handler之后，该Service Handler会主动根据不同的Event类型将其分发给对应的Request Handler来处理。

1. 单线程模型

   <img src = "assets/netty.assets/1555936399411.png" style="zoom:0.6">

2. 多线程模

   <img src = "assets/netty.assets/1555936551304.png" style="zoom:0.6">

3. 主从模型

<img src = "assets/netty.assets/1555936617332.png" style="zoom:0.6">
